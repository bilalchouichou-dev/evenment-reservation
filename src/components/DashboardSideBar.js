  ...
  return (
    <aside className="flex flex-col w-[20%] min-w-72 text-black bg-gray-100" >
      <div className="flex flex-col">
        ...
        <button ref={changeMdpRef} className="text-left px-10 py-4 text-lg font-semibold text-gray-800 hover:text-gray-600" onClick={(e)=>{changingSections(e,donnéesRef/*,plaintsRef*/,eventRef,'changementMDP')}}>changer mot de passe</button>
